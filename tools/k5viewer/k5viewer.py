...
def run_viewer(args: argparse.Namespace, ser: serial.Serial):
    ...
    base_title = f"Quansheng K5Viewer v{VERSION} by N7SIX"
...
def main():
    parser = argparse.ArgumentParser(
        prog="K5Viewer",
        description="A live viewer for UV-K5 radios with N7SIX firmware",
        epilog="N7SIX repo: https://github.com/armel/uv-k5-firmware-custom"
    )
